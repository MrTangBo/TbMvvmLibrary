...
//import com.tb.printlibrary.PrintDataMaker;
//import com.tb.printlibrary.PrinterWriter;
//import com.tb.printlibrary.PrinterWriter58mm;
//import com.tb.printlibrary.PrinterWriter80mm;
//
...
//
//
//    public TestPrintDataMaker(Context context, String st, int width, int height) {
...
//
//            ArrayList<byte[]> image1 = printer.getImageByte(context.getResources(), R.mipmap.ic_launcher);
//            data.addAll(image1);
//
...
////            if (TbQRCodeUtil.createQRImage("2131", 380, 380, null, bitmapPath)) {
////                ArrayList<byte[]> image2 = printer.getImageByte(bitmapPath);
////                data.addAll(image2);
////            } else {
////                ArrayList<byte[]> image2 = printer
////                        .getImageByte(context.getResources(), R.mipmap.ic_launcher);
////                data.addAll(image2);
////            }
//
//            printer.printLineFeed();
