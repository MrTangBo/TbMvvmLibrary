...
class SpannableStringUtils {
    ...
    class Builder(var text: CharSequence?) {
        ...
        private fun setSpan() {
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    mBuilder.setSpan(ImageSpan(TbApplication.mApplicationContext, bitmap!!), start, end, flag)
                    bitmap = null
                    imageIsBitmap = false
                    ...
                    mBuilder.setSpan(ImageSpan(TbApplication.mApplicationContext, uri!!), start, end, flag)
                    uri = null
                    imageIsUri = false
                } else {
                    mBuilder.setSpan(ImageSpan(TbApplication.mApplicationContext, resourceId), start, end, flag)
                    resourceId = 0
