 ...
 * 描述：recycleView万能分割线
 */
class DividerGridItemDecoration constructor(
    ...
    class Builder(private val mContext: Context) {
        ...
        fun setVerticalSpan(mVertical: Float): Builder {
            this.mVerticalSpan = mVertical.toInt()
            return this
        }
        ...
        fun setHorizontalSpan(horizontal: Float): Builder {
            this.mHorizonSpan = horizontal.toInt()
            return this
        }
        ...
        fun build(): DividerGridItemDecoration {
            return DividerGridItemDecoration(mHorizonSpan, mVerticalSpan, mColor, mShowLastLine)
        }
    }
