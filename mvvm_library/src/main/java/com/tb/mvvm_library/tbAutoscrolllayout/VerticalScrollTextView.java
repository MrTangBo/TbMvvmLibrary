package com.tb.mvvm_library.tbAutoscrolllayout;
...
public class VerticalScrollTextView extends RelativeLayout {
    ...
    public VerticalScrollTextView(Context context, AttributeSet attrs) {
        ...
        mTextStyle = array.getInt(R.styleable.VerticalScrollTextView_vst_textStyle, Typeface.NORMAL);
    ...
    private void initTextView(Context context) {
        ...
        mTvContentTop.setTypeface(Typeface.defaultFromStyle(mTextStyle));
        ...
        mTvContentBottom.setTypeface(Typeface.defaultFromStyle(mTextStyle));
